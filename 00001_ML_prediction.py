...
prediction_proba_RF = RF_LH_model.predict_proba(X_data_normalized)[:,1]
prediction_proba_NN = NN_LH_model.predict_proba(X_data_normalized)[:,1]
prediction_proba_GNB = GNB_LH_model.predict_proba(X_data_normalized)[:,1]
prediction_proba_LR = LR_LH_model.predict_proba(X_data_normalized)[:,1]
