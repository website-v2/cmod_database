...
while time < round(((extra_variables['timebase'])[-1]),3):  
    ...
    (data['beta_p'])[j],(data['P_ohm'])[j]])
    j = j + 1
    
#Loading saved model
RF_LH_pkl_filename = '/home/mathewsa/Desktop/RF_classifier_LH-shot-Wmhd-nebar_efit-beta_p-P_ohm.pkl'
RF_LH_model_pkl = open(RF_LH_pkl_filename, 'rb')
RF_LH_model = pickle.load(RF_LH_model_pkl)
NN_LH_pkl_filename = '/home/mathewsa/Desktop/NN_classifier_LH-shot-Wmhd-nebar_efit-beta_p-P_ohm.pkl'
NN_LH_model_pkl = open(NN_LH_pkl_filename, 'rb')
NN_LH_model = pickle.load(NN_LH_model_pkl)
GNB_LH_pkl_filename = '/home/mathewsa/Desktop/GNB_classifier_LH-shot-Wmhd-nebar_efit-beta_p-P_ohm.pkl'
GNB_LH_model_pkl = open(GNB_LH_pkl_filename, 'rb')
GNB_LH_model = pickle.load(GNB_LH_model_pkl)
LR_LH_pkl_filename = '/home/mathewsa/Desktop/LR_classifier_LH-shot-Wmhd-nebar_efit-beta_p-P_ohm.pkl'
LR_LH_model_pkl = open(LR_LH_pkl_filename, 'rb')
LR_LH_model = pickle.load(LR_LH_model_pkl)

scalerfile = '/home/mathewsa/Desktop/scaler_LH-shot-Wmhd-nebar_efit-beta_p-P_ohm.sav'
